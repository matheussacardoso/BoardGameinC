...
void inicio(){
printf("[ŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹŹ]\n");
printf("||                                                                                                                                  ||\n");
printf("||     ***** *               **                ***** **          * ***         ***** *     **            *****  *         **        ||\n");
printf("||  ******  *             *****             ******  ****       *  ****      ******  **    **** *      ******  *        *****        ||\n");
printf("|| **   *  *             *  ***            **   *  *  ***     *  *  ***    **   *  * **    ****      **   *  *        *  ***        ||\n");
    ...
    case 1:
      ...
      case 2:
        system("cls");
				printf ("COMO JOGAR?\n");
        printf("\t\t\t\t\t\t-----------Regras-----------\n");
        printf("1. O JOGO CONSISTE EM UM TABULEIRO DE TAMANHO 12X12, EM QUE SUAS BORDAS SĂO CORDILHEIRAS E NO MEIO É UM LAGO, SENDO ASSIM O SEU CAMPO DE BATALHA SERÁ REPRESENTADO POR UMA ÁREA DE 4X10, O QUAL TERÁ A SUA MAIS A DE SEU INIMIGO. DE INÍCIO, VOCĘ IRÁ POSICIONAR OS SEUS 8 GUERREIROS NO SEU CAMPO DE BATALHA (REPRESENTADOS PELOS NÚMEROS DE 1 OU 2) E MAIS UM GUERREIRO ESPECIAL(REPRESENTADOS PELO # OU @), OU SEJA, 9 GUERREIROS NO TOTAL. EM SEGUIDA, VOCĘ TERÁ 2 OPÇŐES: MOVIMENTAR OU ATACAR.\n\n");
        printf("2. SE A OPÇĂO FOR MOVIMENTAR, É NECESSÁRIO INFORMAR PARA QUAL CASA SE DESEJA IR: POR EXEMPLO, UM GUERREIRO EM UMA CASA 4,4, SÓ PODERIA IR PARA A DIREITA OU ESQUERDA, OU PARA TRÁS, VISTO QUE NA FRENTE DA SUA CASA 4,4 ESTÁ O LAGO. TAMBÉM NĂO É POSSÍVEL MOVIMENTAR POR CIMA DA CORDILHEIRA.\n\n");
        printf("3. SE A OPÇĂO FOR ATACAR E O ATAQUE VIER DE UM GUERREIRO NÚMERO 1, ELE SEMPRE É FRONTAL, SE FOR DE UM NÚMERO 2 ELE É NA DIAGONAL PARA ESQUERDA OU DIREITA, PORTANTO, SENDO UM GUERREIRO DE NÚMERO 2, O JOGADOR PRECISARÁ TAMBÉM DECIDIR SE DEVE ATACAR PARA DIREITA OU PARA ESQUERDA.\n\n");
...
printf("-----------------------------------------------------------------------------------------------------------------------\n");
printf("-----------------------------------------------------------------------------------------------------------------------\n");
printf("BEM VINDOS USUÁRIOS, VOCĘS ESTĂO PRESTES A ENTRAR NO INCRÍVEL MUNDO DA LAPONIA,\n"); 
printf("ONDE VOCĘ TERÁ A OPORTUNIDADE DE PARTICIPAR DE UMA BATALHA ESPETACULAR E INSTIGANTE!\n");
printf("-----------------------------------------------------------------------------------------------------------------------\n");

printmatriz(tabuleiro);

printf("AGORA IREMOS ALOCAR CADA UM DOS SEUS GUERREIROS EM POSIÇŐES\n");
...
n=4;
while(n--){
printf("%s, DIGITE A POSIÇĂO DO GUERREIRO DE PODER 1, DIGITE VALORES APENAS ENTRE AS LINHAS 1 E 4, E AS COLUNAS 1 E 10\n", primeiro);
scanf("%d %d",&x,&y);
if(x<1 || x>4 || y<1 || y>10 || tabuleiro[x][y]!=' '){
	while(1){
		printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
		scanf("%d %d",&x,&y);
...
printf("%s, DIGITE A POSIÇĂO DO GUERREIRO DE PODER 1, DIGITE APENAS VALORES ENRE AS LINHAS 7 E 10, E AS COLUNAS 1 E 10\n", segundo);
scanf("%d %d",&x,&y);
...
printf("-----------------------------------------------------------------------------------------------------------------------\n");
while(n--){
printf("%s, DIGITE A POSIÇĂO DO GUERREIRO DE PODER 2, DIGITE VALORES ENTRE AS LINHAS 1 E 4, E AS COLUNAS 1 E 1O\n", primeiro);
scanf("%d %d",&x,&y);
if(x<1 || x>4 || y<1 || y>10 || tabuleiro[x][y]!=' '){
	while(1){
		printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
...
printf("%s, DIGITE A POSIÇĂO DO GUERREIRO DE PODER 2, DIGITE VALORES ENTRE AS LINHAS 7 E 10, E AS COLUNAS 1 E 1O\n", segundo);
scanf("%d %d",&x,&y);
if(x<7 || x>10 || y<1 || y>10 || tabuleiro[x][y]!=' '){
	while(1){
		printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
...
printf("-----------------------------------------------------------------------------------------------------------------------\n");
printf("PRESTE ATENÇĂO!!! AGORA VAMOS AOS GUERREIROS ESPECIAIS\n");
printf("-----------------------------------------------------------------------------------------------------------------------\n");
printf("ESTES POSSUEM HABILIDADES CATASTRÓFICAS\n");
printf("-----------------------------------------------------------------------------------------------------------------------\n");
printf("%s DIGITE A POSIÇĂO DO SEU GUERREIRO ESPECIAL, DIGITE OS VALORES  APENAS ENTRE AS LINHAS 1 E 4, E AS COLUNAS 1 E 10\n", primeiro);
scanf("%d %d",&x,&y);
if(x<1 || x>4 || y<1 || y>10 || tabuleiro[x][y]!=' '){
	while(1){
		printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
...
printf("%s DIGITE A POSIÇĂO DO SEU GUERREIRO ESPECIAL, DIGITE VALORES APENAS ENTRE AS LINHAS 7 E 10, E AS COLUNAS 1 E 10\n", segundo);
scanf("%d %d",&x,&y);
if(x<7 || x>10 || y<1 || y>10 || tabuleiro[x][y]!=' '){
	while(1){
		printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
...
while(qnt1!=0 && qnt2!=0){
	...
	/* MOVIMENTAÇĂO*/
	if(andar==1){
	printf("DIGITE A POSIÇĂO DA PEÇA E PARA ONDE DESEJA MOVE-LA\n");
	...
	/* ATAQUE*/
		...
		scanf("%d %d",&p3,&p4);
				...
				for(i=p3;i<12;i++){
				   	if(i>=7){
						if(tabuleiro[i][p4]=='1' || tabuleiro[i][p4]=='2' || tabuleiro[i][p4]=='#'){
							tabuleiro[i][p4]=' ';
							printf("O GUERREIRO NA POSIÇĂO %d %d FOI ELIMINADO\n",i,p4);
							sleep(2);
							printmatriz(tabuleiro);
							qnt2--;
							break;
			...
			printf("SELECIONE QUAL DIREÇĂO ATACAR (1- DIAGONAL ESQUERDA, 2- DIAGONAL DIREITA)\n");
			scanf("%d",&direcao);
	...
	/* DIAGONAL DIREITA*/
				...
				printmatriz(tabuleiro);
					...
					int quad_sort,num1=0;
						...
						while(quad_sort==num1); //sortea até que o "a" năo seja um número que eu defini
						quadrante=quad_sort;
						switch (quadrante){
					  	case 1: 
	...
	if(andar==1){
		...
		printmatriz(tabuleiro);	
			...
			printf("DIGITE QUAL A PEÇA VOCĘ DESEJA UTILIZAR PARA O ATAQUE\n");
			scanf("%d %d",&p3,&p4);
			if(p3<7 || tabuleiro[p3][p4]==' ' || tabuleiro[p3][p4]=='~'){
				while(1){
					printf("PREZADO... NĂO COMPLIQUE... A POSIÇĂO QUE VOCĘ DIGITOU É INVÁLIDA!!!\n");
